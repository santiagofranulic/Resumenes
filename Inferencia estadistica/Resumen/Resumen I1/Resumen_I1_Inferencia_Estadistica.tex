...
\section{Evaluación de Estimadores Puntuales}
...
\begin{definicion}{Sesgo}{}
    ...
    \end{equation*}
    \begin{itemize}
        \item $\text{Sesgo}(\hat{\theta}) > 0 \implies $ Sobreestimado
        \item $\text{Sesgo}(\hat{\theta}) < 0 \implies $ Subestimado
        \item $\text{Sesgo}(\hat{\theta}) = 0 \implies $ Insesgado
    \end{itemize}
\end{definicion}
...
\begin{definicion}{Error Cuadrático Medio}{ECM}
